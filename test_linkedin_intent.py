...
check("A8 az engine-verzio bumpolva", ENGINE_VERSION.endswith("v7"), ENGINE_VERSION)
...
check("J11 az engine-verzio a valaszban v7", res_on.get("engine") == "linkedin-tle-v7")
