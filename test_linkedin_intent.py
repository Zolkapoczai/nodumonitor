...
check("A8 az engine-verzio bumpolva", ENGINE_VERSION.endswith("v24"), ENGINE_VERSION)
...
check("J11 az engine-verzio a valaszban v24", res_on.get("engine") == "linkedin-tle-v24")
